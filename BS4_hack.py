...
response = urllib.request.urlopen('http://democracy.devon.gov.uk/mgWebService.asmx/GetMeeting?lMeetingId=243')
...
soup = BeautifulSoup(html_doc, 'html5lib') # this one works fine with examples so far
...
# testing the child finder - not currently working :(
